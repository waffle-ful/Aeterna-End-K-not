...
public static class CaptureTheFlag
{
    ...
    public static class FixedUpdatePatch
    {
        ...
        {
            if (!AmongUsClient.Instance.AmHost || !GameStates.IsInTask || ExileController.Instance || Options.CurrentGameMode != CustomGameMode.CaptureTheFlag || !Main.IntroDestroyed || __instance.PlayerId >= 200 || WinnerData.Team != "No one wins") return;
