...
internal static class StopAndGo
{
    ...
    public static class FixedUpdatePatch
    {
        ...
        {
            if (!GameStates.IsInTask || ExileController.Instance || Options.CurrentGameMode != CustomGameMode.StopAndGo || !__instance.IsAlive() || !AmongUsClient.Instance.AmHost || !DoChecks || !Main.IntroDestroyed || __instance.PlayerId >= 200) return;
