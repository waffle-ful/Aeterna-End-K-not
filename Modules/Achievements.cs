...
public static class Achievements
{
    public enum Type
    {
        ...
        FuriousAvenger, // Find yourself in a situation when Overkiller kills Avenger and everyone dies
    ...
    private static readonly string SaveFilePath = $"{Main.DataPath}/EndKnot_DATA/Achievements.json";
    ...
    private static void SaveAllData()
    {
        ...
        // External achievement sync disabled
        if (false && !Options.StoreCompletedAchievementsOnEHRDatabase.GetBool()) return;
    ...
    public static void LoadAllData()
    {
        ...
        // External achievement load disabled
        else if (false && Options.StoreCompletedAchievementsOnEHRDatabase.GetBool())
        {
