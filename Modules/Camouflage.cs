...
public static class Camouflage
{
    ...
    public static void Init()
    {
        ...
        CamouflageOutfit = Options.KPDCamouflageMode.GetValue() switch
        {
            ...
            3 => new NetworkedPlayerInfo.PlayerOutfit().Set("", 7, "hat_pk04_Snowman", "", "", "", ""), // Gurge44
            4 => new NetworkedPlayerInfo.PlayerOutfit().Set("", 17, "hat_baseball_Black", "skin_Scientist-Darkskin", "visor_pusheenSmileVisor", "pet_Pip", ""), // TommyXL
    ...
    private static IEnumerator UpdateCamouflageStatusAsync()
    {
        ...
        System.Collections.IEnumerator notifyEveryone = Utils.NotifyEveryoneAsync();
