...
internal static class CustomRolesHelper
{
    ...
    extension(CustomRoles role)
    {
        ...
        public CustomRoles GetVNRole(bool checkDesyncRole = false)
        {
            ...
            return role switch
            {
                ...
                CustomRoles.Operative => UsePets ? CustomRoles.Crewmate : CustomRoles.Engineer,
                ...
                CustomRoles.Ballooner => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.EvilJumper => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.EvilMagician => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.EvilTeller => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.EvilBomber => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.AntiReporter => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.CharismaStar => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.EvilBlender => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.Archer => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.EvilMaker => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                CustomRoles.NiceLogger => CustomRoles.Crewmate,
                CustomRoles.SantaClaus => CustomRoles.Engineer,
                CustomRoles.VentMaster => VentMaster.CanUseVentOption.GetBool() ? CustomRoles.Engineer : CustomRoles.Crewmate,
                CustomRoles.VentOpener => CustomRoles.Engineer,
                CustomRoles.ToiletFan => CustomRoles.Crewmate,
                CustomRoles.Android => CustomRoles.Engineer,
                CustomRoles.Comebacker => CustomRoles.Engineer,
                CustomRoles.Snowman => CustomRoles.Crewmate,
                CustomRoles.Shyboy => CustomRoles.Crewmate,
                CustomRoles.Satellite => CustomRoles.Crewmate,
                CustomRoles.ProBowler => CustomRoles.Shapeshifter,
                CustomRoles.TeleportKiller => CustomRoles.Shapeshifter,
                CustomRoles.ConnectSaver => CustomRoles.Impostor,
                CustomRoles.ProgressKiller => CustomRoles.Impostor,
                ...
                CustomRoles.QuickKiller => UsePets ? CustomRoles.Impostor : CustomRoles.Shapeshifter,
                ...
                CustomRoles.Missioneer => CustomRoles.Engineer,
                ...
                CustomRoles.ImpostorEndKnot => CustomRoles.Impostor,
                CustomRoles.PhantomEndKnot => CustomRoles.Phantom,
                CustomRoles.ShapeshifterEndKnot => CustomRoles.Shapeshifter,
                CustomRoles.CrewmateEndKnot => CustomRoles.Crewmate,
                CustomRoles.EngineerEndKnot => CustomRoles.Engineer,
                CustomRoles.ScientistEndKnot => CustomRoles.Scientist,
                CustomRoles.TrackerEndKnot => CustomRoles.Tracker,
                CustomRoles.NoisemakerEndKnot => CustomRoles.Noisemaker,
                CustomRoles.DetectiveEndKnot => CustomRoles.Detective,
                CustomRoles.ViperEndKnot => CustomRoles.Viper,
        ...
        public CustomRoles GetErasedRole()
        {
            if (role.IsVanilla()) return role;
            ...
            {
                CustomRoles.Crewmate => CustomRoles.CrewmateEndKnot,
                CustomRoles.Engineer => CustomRoles.EngineerEndKnot,
                CustomRoles.Noisemaker => CustomRoles.NoisemakerEndKnot,
                CustomRoles.Tracker => CustomRoles.TrackerEndKnot,
                CustomRoles.Scientist => CustomRoles.ScientistEndKnot,
                CustomRoles.Impostor when role.IsCrewmate() => CustomRoles.CrewmateEndKnot,
                CustomRoles.Impostor => CustomRoles.ImpostorEndKnot,
                CustomRoles.Phantom => CustomRoles.PhantomEndKnot,
                CustomRoles.Shapeshifter => CustomRoles.ShapeshifterEndKnot,
                CustomRoles.Detective => CustomRoles.DetectiveEndKnot,
                CustomRoles.Viper => CustomRoles.ViperEndKnot,
                _ => role.IsImpostor() ? CustomRoles.ImpostorEndKnot : CustomRoles.CrewmateEndKnot
            };
        }

        public RoleTypes GetDYRole(bool load = false)
        {
            ...
            return role switch
            {
                ...
                CustomRoles.WolfBoy => RoleTypes.Impostor,
                ...
                CustomRoles.Remotekiller => RoleTypes.Impostor,
        ...
        public bool IsAdditionRole()
        {
            return role > CustomRoles.NotAssigned;
        }

        public bool IsNonNK(bool check = false)
        {
        ...
        public bool IsImpostor()
        {
            ...
            return (role == CustomRoles.DoubleAgent && (!Options.IsLoaded || !Main.IntroDestroyed)) || role is
                ...
                CustomRoles.PhantomEndKnot or
                CustomRoles.Shapeshifter or
                CustomRoles.ShapeshifterEndKnot or
                CustomRoles.Viper or
                CustomRoles.ViperEndKnot or
                ...
                CustomRoles.Notifier or
                CustomRoles.EvilGambler or
                CustomRoles.EvilTeller or
                CustomRoles.EvilBomber or
                CustomRoles.EvilMagician or
                CustomRoles.EvilSatellite or
                CustomRoles.ProBowler or
                CustomRoles.TeleportKiller or
                CustomRoles.ConnectSaver or
                CustomRoles.ProgressKiller or
                CustomRoles.AntiReporter or
                CustomRoles.CharismaStar or
                CustomRoles.EvilBlender or
                CustomRoles.Decrescendo or
                CustomRoles.Archer or
                CustomRoles.EvilMaker or
                ...
                CustomRoles.Ballooner or
                CustomRoles.EvilJumper or
        ...
        public bool CancelsVote()
        {
            return role switch
            {
                ...
                CustomRoles.Satellite => true,
                CustomRoles.Balancer => true,
                CustomRoles.Pathologist => true,
                CustomRoles.ShrineMaiden => true,
                CustomRoles.Teller => true,
        ...
        public bool OnlySpawnsWithPets()
        {
        ...
        public bool NeedUpdateOnLights()
        {
            return role is CustomRoles.Wiper;
        }

        public bool IsBetrayalAddon()
        {
            return role is
                CustomRoles.Charmed or
                CustomRoles.Contagious or
        ...
        public bool IsNotAssignableMidGame()
        {
            return role is
                CustomRoles.Egoist or
        ...
        public bool AlwaysUsesPhantomBase()
        {
            return role is
        ...
        public bool SimpleAbilityTrigger()
        {
            return role switch
            {
                ...
                _ => role is CustomRoles.Dasher
                             ...
                             or CustomRoles.Ballooner
                             or CustomRoles.EvilJumper
                             or CustomRoles.EvilMagician
                             or CustomRoles.EvilTeller
                             or CustomRoles.EvilBomber
                             or CustomRoles.AntiReporter
                             or CustomRoles.CharismaStar
                             or CustomRoles.EvilBlender
                             or CustomRoles.Archer
                             or CustomRoles.EvilMaker
        ...
        public RoleOptionType GetNeutralRoleCategory()
        {
            return role switch
            {
                ...
                CustomRoles.Banker => RoleOptionType.Neutral_Benign,
                CustomRoles.Monochromer => RoleOptionType.Neutral_Benign,
                CustomRoles.Turncoat => RoleOptionType.Neutral_Benign,
                CustomRoles.Remotekiller => RoleOptionType.Neutral_Killing,
                CustomRoles.Strawdoll => RoleOptionType.Neutral_Killing,
                CustomRoles.CurseMaker => RoleOptionType.Neutral_Killing,
                CustomRoles.Missioneer => RoleOptionType.Neutral_Benign,
        ...
        public RoleOptionType GetImpostorRoleCategory()
        {
            return role switch
            {
                ...
                CustomRoles.Ballooner => RoleOptionType.Impostor_Killing,
                CustomRoles.EvilJumper => RoleOptionType.Impostor_Killing,
                CustomRoles.EvilMagician => RoleOptionType.Impostor_Killing,
                CustomRoles.EvilGambler => RoleOptionType.Impostor_Killing,
                CustomRoles.EvilTeller => RoleOptionType.Impostor_Killing,
                CustomRoles.ProBowler => RoleOptionType.Impostor_Killing,
                CustomRoles.EvilBomber => RoleOptionType.Impostor_Killing,
                CustomRoles.TeleportKiller => RoleOptionType.Impostor_Killing,
                CustomRoles.ProgressKiller => RoleOptionType.Impostor_Killing,
                CustomRoles.AntiReporter => RoleOptionType.Impostor_Killing,
                CustomRoles.CharismaStar => RoleOptionType.Impostor_Killing,
                CustomRoles.EvilBlender => RoleOptionType.Impostor_Support,
                CustomRoles.Decrescendo => RoleOptionType.Impostor_Killing,
                CustomRoles.DummySpawner => RoleOptionType.Impostor_Killing,
                CustomRoles.Archer => RoleOptionType.Impostor_Killing,
                CustomRoles.EvilMaker => RoleOptionType.Impostor_Support,
                ...
                CustomRoles.EarnestWolf => RoleOptionType.Impostor_Killing,
                CustomRoles.Limiter => RoleOptionType.Impostor_Killing,
                CustomRoles.QuickKiller => RoleOptionType.Impostor_Killing,
                ...
                CustomRoles.Insider => RoleOptionType.Impostor_Support,
                CustomRoles.Notifier => RoleOptionType.Impostor_Support,
                CustomRoles.EvilSatellite => RoleOptionType.Impostor_Support,
                CustomRoles.ConnectSaver => RoleOptionType.Impostor_Support,
                ...
                CustomRoles.Shuffler => RoleOptionType.Impostor_Support,
                ...
                CustomRoles.ImpostorEndKnot => RoleOptionType.Impostor_Miscellaneous,
                CustomRoles.Shapeshifter => RoleOptionType.Impostor_Miscellaneous,
                CustomRoles.ShapeshifterEndKnot => RoleOptionType.Impostor_Miscellaneous,
                CustomRoles.Phantom => RoleOptionType.Impostor_Miscellaneous,
                CustomRoles.PhantomEndKnot => RoleOptionType.Impostor_Miscellaneous,
                CustomRoles.Viper => RoleOptionType.Impostor_Miscellaneous,
                CustomRoles.ViperEndKnot => RoleOptionType.Impostor_Miscellaneous,
        ...
        public RoleOptionType GetCrewmateRoleCategory()
        {
            return role switch
            {
                CustomRoles.Crewmate => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.CrewmateEndKnot => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.Engineer => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.EngineerEndKnot => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.Scientist => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.ScientistEndKnot => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.Tracker => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.TrackerEndKnot => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.Noisemaker => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.NoisemakerEndKnot => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.Detective => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.DetectiveEndKnot => RoleOptionType.Crewmate_Miscellaneous,
                ...
                CustomRoles.Gemini => RoleOptionType.Crewmate_Miscellaneous,
                ...
                CustomRoles.NiceLogger => RoleOptionType.Crewmate_Investigate,
                CustomRoles.VentMaster => RoleOptionType.Crewmate_Investigate,
                CustomRoles.Satellite => RoleOptionType.Crewmate_Investigate,
                CustomRoles.Pathologist => RoleOptionType.Crewmate_Investigate,
                CustomRoles.ShrineMaiden => RoleOptionType.Crewmate_Investigate,
                ...
                CustomRoles.VentOpener => RoleOptionType.Crewmate_Support,
                CustomRoles.ToiletFan => RoleOptionType.Crewmate_Support,
                CustomRoles.Android => RoleOptionType.Crewmate_Support,
                CustomRoles.Comebacker => RoleOptionType.Crewmate_Support,
                ...
                CustomRoles.Gasp => RoleOptionType.Crewmate_Investigate,
                CustomRoles.UltraStar => RoleOptionType.Crewmate_Miscellaneous,
                CustomRoles.Balancer => RoleOptionType.Crewmate_Miscellaneous,
        ...
        public bool IsCoven()
        {
            return role is
                ...
                CustomRoles.MoonDancer or
                CustomRoles.Shadow;
        }

        public bool IncompatibleWithVenom()
        {
            return role switch
            {
        ...
        public bool IsRevealingRole(PlayerControl target)
        {
    ...
    {
        public Color GetRoleOptionTypeColor()
        {
            return type switch
            {
        ...
        public TabGroup GetTabFromOptionType()
        {
            return type switch
            {
    ...
    public static bool CheckAddonConflict(CustomRoles role, PlayerControl pc, bool validateExistingState = false)
    {
        return role.IsAdditionRole() && !(role.IsGhostRole() && pc.IsAlive()) && (!Main.NeverSpawnTogetherCombos.TryGetValue(OptionItem.CurrentPreset, out Dictionary<CustomRoles, List<CustomRoles>> neverList) || !neverList.TryGetValue(pc.GetCustomRole(), out List<CustomRoles> bannedAddonList) || !bannedAddonList.Contains(role)) && pc.GetCustomRole() is not CustomRoles.GuardianAngelEndKnot and not CustomRoles.God && !pc.Is(CustomRoles.Madmate) && !pc.Is(CustomRoles.GM) && (validateExistingState || role is not CustomRoles.Lovers) && !pc.Is(CustomRoles.LazyGuy) && (validateExistingState || (Main.IntroDestroyed && Options.AddonAssigningRolesIgnoreMaxAddonsLimit.GetBool()) || !pc.HasSubRole() || pc.GetCustomSubRoles().Count < Options.NoLimitAddonsNumMax.GetInt()) && (!Options.AddonCanBeSettings.TryGetValue(role, out (OptionItem Imp, OptionItem Neutral, OptionItem Crew, OptionItem Coven) o) || ((o.Imp.GetBool() || !pc.GetCustomRole().IsImpostor()) && (o.Neutral.GetBool() || !pc.GetCustomRole().IsNeutral()) && (o.Crew.GetBool() || !pc.IsCrewmate()) && (o.Coven.GetBool() || !pc.Is(Team.Coven)))) && (!role.IsImpOnlyAddon() || (pc.IsImpostor() && !pc.Is(CustomRoles.DoubleAgent)) || (pc.Is(CustomRoles.Traitor) && Traitor.CanGetImpostorOnlyAddons.GetBool())) && role switch
        {
            ...
            CustomRoles.Autopsy when pc.Is(CustomRoles.Doctor) || pc.Is(CustomRoles.Tracefinder) || pc.Is(CustomRoles.Scientist) || pc.Is(CustomRoles.ScientistEndKnot) || pc.Is(CustomRoles.Sunnyboy) => false,
            ...
            CustomRoles.Torch when pc.Is(CustomRoles.Bewilder) || pc.Is(CustomRoles.Sunglasses) || pc.Is(CustomRoles.GuardianAngelEndKnot) => false,
            CustomRoles.Bewilder when pc.Is(CustomRoles.Torch) || pc.Is(CustomRoles.GuardianAngelEndKnot) || pc.Is(CustomRoles.Sunglasses) => false,
            ...
            CustomRoles.Sunglasses when pc.Is(CustomRoles.Torch) || pc.Is(CustomRoles.GuardianAngelEndKnot) || pc.Is(CustomRoles.Bewilder) => false,
            ...
            CustomRoles.Oblivious when pc.Is(CustomRoles.Forensic) || pc.Is(CustomRoles.Cleaner) || pc.Is(CustomRoles.Medusa) || pc.Is(CustomRoles.Mortician) || pc.Is(CustomRoles.Medium) || pc.Is(CustomRoles.GuardianAngelEndKnot) => false,
            CustomRoles.Youtuber when !pc.IsCrewmate() || pc.Is(CustomRoles.Madmate) || pc.Is(CustomRoles.Sheriff) || pc.Is(CustomRoles.GuardianAngelEndKnot) => false,
            ...
            CustomRoles.DoubleCount when (!pc.IsImpostor() && !pc.IsCrewmate()) || pc.Is(CustomRoles.Madmate) => false,
            ...
            CustomRoles.Bait when pc.Is(CustomRoles.GuardianAngelEndKnot) => false,
            CustomRoles.Bait when pc.Is(CustomRoles.Beartrap) => false,
            CustomRoles.Beartrap when pc.Is(CustomRoles.Bait) => false,
            CustomRoles.DoubleCount when pc.Is(CustomRoles.Dictator) => false,
            CustomRoles.Swift when pc.GetCustomRole() is CustomRoles.Swooper or CustomRoles.Vampire or CustomRoles.Scavenger or CustomRoles.Puppeteer or CustomRoles.Warlock or CustomRoles.Consigliere or CustomRoles.Witch or CustomRoles.Nemesis or CustomRoles.Viper or CustomRoles.ViperEndKnot => false,
            ...
            CustomRoles.Beartrap when pc.Is(CustomRoles.GuardianAngelEndKnot) => false,
            ...
            CustomRoles.Fool when pc.GetCustomRole() is CustomRoles.Mechanic or CustomRoles.GuardianAngelEndKnot or CustomRoles.Technician => false,
