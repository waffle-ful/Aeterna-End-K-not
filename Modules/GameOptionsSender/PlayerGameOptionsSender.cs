...
public sealed class PlayerGameOptionsSender(PlayerControl player) : GameOptionsSender
{
    ...
    public override IGameOptions BuildGameOptions()
    {
        try
        {
            ...
            switch (Options.CurrentGameMode)
            {
                ...
                case CustomGameMode.Standard:
                {
                    ...
                    foreach (CustomRoles subRole in state.SubRoles)
                    {
                        ...
                        {
                            AURoleOptions.GuardianAngelCooldown = 5f;
                            continue;
                        }
            ...
            switch (role)
            {
                case CustomRoles.PhantomEndKnot:
                    ...
                    break;
                case CustomRoles.ShapeshifterEndKnot:
                    ...
                    break;
                case CustomRoles.EngineerEndKnot:
                    ...
                    break;
                case CustomRoles.NoisemakerEndKnot:
                    ...
                    break;
                case CustomRoles.ScientistEndKnot:
                    ...
                    break;
                case CustomRoles.TrackerEndKnot:
                    ...
                    break;
                case CustomRoles.DetectiveEndKnot:
            ...
            if (!player.Is(CustomRoles.Focused) && Main.AllAlivePlayerControlsToList.Any(x => x.Is(CustomRoles.Bewilder) && !x.IsAlive() && x.GetRealKiller()?.PlayerId == player.PlayerId && !x.Is(CustomRoles.Hangman)))
            {
                opt.SetVision(false);
                opt.SetFloat(FloatOptionNames.CrewLightMod, Options.BewilderVision.GetFloat());
                opt.SetFloat(FloatOptionNames.ImpostorLightMod, Options.BewilderVision.GetFloat());
