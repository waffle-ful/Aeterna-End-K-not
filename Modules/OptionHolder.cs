...
public static class Options
{
    ...
    public static OptionItem EnableImpostorChat;
    public static OptionItem EnableJackalChat;
    public static OptionItem EnableLoversChat;
    ...
    private static IEnumerator Load()
    {
        ...
        EnableImpostorChat = new BooleanOptionItem(19320, "EnableImpostorChat", true, TabGroup.SystemSettings);
        EnableJackalChat = new BooleanOptionItem(19331, "EnableJackalChat", true, TabGroup.SystemSettings);
        EnableLoversChat = new BooleanOptionItem(19332, "EnableLoversChat", true, TabGroup.SystemSettings);
        ...
        StoreCompletedAchievementsOnEHRDatabase = new BooleanOptionItem(19423, "StoreCompletedAchievementsOnEHRDatabase", false, TabGroup.SystemSettings);

        AllCrewRolesHaveVanillaColor = new BooleanOptionItem(19424, "AllCrewRolesHaveVanillaColor", false, TabGroup.SystemSettings)
            .SetHeader(true);

        MessageRpcSizeLimit = new IntegerOptionItem(19425, "MessageRpcSizeLimit", new(500, 100000, 100), 1200, TabGroup.SystemSettings)
            .SetHeader(true);
