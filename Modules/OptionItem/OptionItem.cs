...
public abstract class OptionItem
{
    ...
    public OptionItem SetParent(OptionItem parent)
    {
        return Do(i =>
        {
            foreach (KeyValuePair<CustomRoles, StringOptionItem> role in EndKnot.Options.CustomRoleSpawnChances)
            {
    ...
    public bool IsCurrentlyHidden(bool forLobbyView = false, bool checkCollapsedSection = true)
    {
        ...
        static bool Hidden(OptionItem oi, bool forLobbyView, bool checkCollapsedSection)
        {
            ...
            CustomGameMode mode = !forLobbyView ? EndKnot.Options.CurrentGameMode : LobbyViewSettingsPanePatch.LastGameModeSelected;
            ...
            return (oi.IsHidden || (oi.GameMode != CustomGameMode.All && oi.GameMode != mode) ||
                   ...
                   !(oi.GameMode == nd && EndKnot.Options.IntegrateNaturalDisasters.GetBool());
        }
    }
