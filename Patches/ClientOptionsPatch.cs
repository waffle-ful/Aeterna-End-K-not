...
public static class OptionsMenuBehaviourStartPatch
{
    ...
    private static ClientOptionItem EnableBGM;
    private static ClientOptionItem ShowBGMInfo;
    ...
    public static void Postfix(OptionsMenuBehaviour __instance)
    {
        ...
        if (EnableBGM == null || !EnableBGM.ToggleButton)
        {
            EnableBGM = ClientOptionItem.Create("BGMEnable", Main.EnableBGM, __instance, EnableBGMButtonToggle);
        ...
        if (ShowBGMInfo == null || !ShowBGMInfo.ToggleButton)
            ShowBGMInfo = ClientOptionItem.Create("BGMShowInfo", Main.ShowBGMInfo, __instance);
