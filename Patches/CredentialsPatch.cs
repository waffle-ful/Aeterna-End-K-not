...
public static class UpdateFriendCodeUIPatch
{
    ...
    public static void Prefix()
    {
        ...
        if (friendCode && !VersionShower)
        {
            ...
            VersionShower.name = "EndKnot Version Shower";
...
internal static class TitleLogoPatch
{
    ...
    private static void Postfix(MainMenuManager __instance)
    {
        ...
        if (!CustomBG && (holidays || christmas || newYear || easter))
        {
            ...
            sr.sprite = Utils.LoadSprite(easter ? "EndKnot.Resources.Images.EasterBG.jpg" : "EndKnot.Resources.Images.WinterBG.jpg", 180f);
        ...
        closeRightSpriteRenderer.sprite = Utils.LoadSprite("EndKnot.Resources.Images.RightPanelCloseButton.png", 100f);
