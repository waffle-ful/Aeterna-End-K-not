        ...
        try
        {
            PlayerControl.LocalPlayer.Data.Role.IntroSound = role switch
            {
                ...
                CustomRoles.Engineer or
                    CustomRoles.EngineerEndKnot or
                ...
                CustomRoles.Scientist or
                    CustomRoles.ScientistEndKnot or
                    CustomRoles.Aid or
                ...
                CustomRoles.Detective
                    or CustomRoles.DetectiveEndKnot
                ...
                CustomRoles.Noisemaker
                    or CustomRoles.NoisemakerEndKnot
                ...
                CustomRoles.Shapeshifter
                    or CustomRoles.ShapeshifterEndKnot
        ...
        if (AmongUsClient.Instance.AmHost)
        {
            ...
            if (Options.UsePets.GetBool() && Options.CurrentGameMode is CustomGameMode.Standard or CustomGameMode.HideAndSeek or CustomGameMode.CaptureTheFlag or CustomGameMode.BedWars or CustomGameMode.Snowdown)
            {
                ...
                System.Collections.IEnumerator ShowPetForEveryone()
                {
                    ...
                    // 公式鯖では SetPet が正規 serialize (SyncOutfitData) で shapeshift リフレッシュ込みのため、表示用 spoof shapeshift は不要・有害
                    if (GameStates.CurrentServerType == GameStates.ServerType.Vanilla) yield break;
