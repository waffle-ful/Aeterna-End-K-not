...
public static class CredentialsPatch
{
    ...
    public static class LogoPatch
    {
        ...
        public static void InitCredentialsData()
        {
            ...
            DevsData += $"<color=#888888>Based on EHR by Gurge44 / Based on TownOfHost-K by KYMario</color>";
            DevsData += $"\n<color={Main.ModColor}>♥咔皮呆 & Gurge44</color> - <size=75%>{GetString("MainDev")}</size>";
