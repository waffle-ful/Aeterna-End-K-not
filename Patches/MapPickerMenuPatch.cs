...
public static class GameOptionsMapPickerPatch
{
    ...
    public static void Postfix_Prefix(GameOptionsMapPicker __instance)
    {
        if (!__instance.AllMapIcons.ToArray().Any(x => x.Name == MapNames.Dleks))
        {
            ...
            {
                Name = MapNames.Dleks,
                MapImage = Utils.LoadSprite("EndKnot.Resources.Images.DleksBanner.png", 100f),
                MapIcon = Utils.LoadSprite("EndKnot.Resources.Images.DleksBanner-Icon.png", 95f),
                NameImage = Utils.LoadSprite("EndKnot.Resources.Images.DleksBanner-Wordart.png", 160f),
            });
        }
        if (SubmergedCompatibility.Loaded)
        {
            if (!__instance.AllMapIcons.ToArray().Any(x => x.Name == (MapNames)6))
            {
                ...
                {
                    Name = (MapNames)6,
                    MapImage = Utils.LoadSprite("EndKnot.Resources.Images.SubmergedBanner.png", 100f),
                    //MapIcon = Utils.LoadSprite("EndKnot.Resources.Images.Submerged-Icon.png", 100f),
                    NameImage = Utils.LoadSprite("EndKnot.Resources.Images.Submerged-Wordart.png", 100f),
                });
            }
        }
    }
            ...
            if (AllMapButton != null)
            {
                // Dleks Button
                {
                    ...
                    dleksButton_MapButton.Button.OnClick.AddListener((Action)(() =>
                    {
                        ...
                        __instance.MapImage.sprite = Utils.LoadSprite("EndKnot.Resources.Images.DleksBanner.png", 100f);
                        __instance.MapName.sprite = Utils.LoadSprite("EndKnot.Resources.Images.DleksBanner-Wordart.png", 100f);
                    }));
                ...
                if (SubmergedCompatibility.Loaded)
                {
                    ...
                    submergedButton_MapButton.Button.OnClick.AddListener((Action)(() =>
                    {
                        ...
                        //__instance.MapImage.sprite = Utils.LoadSprite("EndKnot.Resources.Images.SubmergedBanner.png", 100f);
                        //__instance.MapName.sprite = Utils.LoadSprite("EndKnot.Resources.Images.Submerged-Wordart.png", 100f);
                    }));
