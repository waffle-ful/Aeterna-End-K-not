...
public class Disguiser : RoleBase, IHideAndSeekRole
{
    ...
    {
        Options.SetupRoleOptions(706300, TabGroup.ImpostorRoles, CustomRoles.Disguiser, CustomGameMode.HideAndSeek);

        Vision = new FloatOptionItem(706302, "DisguiserVision", new(0.05f, 5f, 0.05f), 0.25f, TabGroup.ImpostorRoles)
            .SetGameMode(CustomGameMode.HideAndSeek)
            .SetValueFormat(OptionFormat.Multiplier)
            .SetColor(new(179, 70, 70, byte.MaxValue))
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.Disguiser]);

        Speed = new FloatOptionItem(706303, "DisguiserSpeed", new(0.05f, 5f, 0.05f), 1.5f, TabGroup.ImpostorRoles)
            .SetGameMode(CustomGameMode.HideAndSeek)
            .SetValueFormat(OptionFormat.Multiplier)
            .SetColor(new(179, 70, 70, byte.MaxValue))
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.Disguiser]);

        CanOnlyKillShapeshiftTarget = new BooleanOptionItem(706304, "DisguiserCanOnlyKillShapeshiftTarget", true, TabGroup.ImpostorRoles)
            .SetGameMode(CustomGameMode.HideAndSeek)
            .SetColor(new(179, 70, 70, byte.MaxValue))
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.Disguiser]);

        PenaltyForWrongKillAttempt = new StringOptionItem(706305, "DisguiserPenaltyForWrongKillAttempt", ["DisguiserPFWKA.BlockKill", "DisguiserPFWKA.Suicide", "DisguiserPFWKA.ResetKillCooldown"], 1, TabGroup.ImpostorRoles)
            .SetGameMode(CustomGameMode.HideAndSeek)
            .SetColor(new(179, 70, 70, byte.MaxValue))
        ...
        ToleranceBeforeSuicide = new IntegerOptionItem(706306, "DisguiserToleranceBeforeSuicide", new(0, 14, 1), 2, TabGroup.ImpostorRoles)
            .SetGameMode(CustomGameMode.HideAndSeek)
            .SetValueFormat(OptionFormat.Times)
            .SetColor(new(179, 70, 70, byte.MaxValue))
            .SetParent(PenaltyForWrongKillAttempt);

        ResetKillCooldownTo = new FloatOptionItem(706307, "DisguiserResetKillCooldownTo", new(0.5f, 120f, 0.5f), 10f, TabGroup.ImpostorRoles)
            .SetGameMode(CustomGameMode.HideAndSeek)
            .SetValueFormat(OptionFormat.Seconds)
            .SetColor(new(179, 70, 70, byte.MaxValue))
            .SetParent(PenaltyForWrongKillAttempt);

        ShapeshiftCooldown = new IntegerOptionItem(706308, "DisguiserShapeshiftCooldown", new(0, 180, 1), 0, TabGroup.ImpostorRoles)
            .SetGameMode(CustomGameMode.HideAndSeek)
            .SetValueFormat(OptionFormat.Seconds)
            .SetColor(new(179, 70, 70, byte.MaxValue))
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.Disguiser]);

        ShapeshiftDuration = new IntegerOptionItem(706309, "DisguiserShapeshiftDuration", new(0, 180, 1), 30, TabGroup.ImpostorRoles)
            .SetGameMode(CustomGameMode.HideAndSeek)
            .SetValueFormat(OptionFormat.Seconds)
            .SetColor(new(179, 70, 70, byte.MaxValue))
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.Disguiser]);
