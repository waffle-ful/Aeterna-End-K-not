...
public class Workhorse : IAddon
{
    ...
    private static bool IsAssignTarget(PlayerControl pc)
    {
        ...
        if (pc.GetCustomRole().GetVNRole(true) is CustomRoles.Impostor or CustomRoles.ImpostorEndKnot or CustomRoles.Shapeshifter or CustomRoles.ShapeshifterEndKnot or CustomRoles.Phantom or CustomRoles.PhantomEndKnot or CustomRoles.Viper or CustomRoles.ViperEndKnot) return false;
