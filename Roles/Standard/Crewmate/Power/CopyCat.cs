    ...
    public override bool OnCheckMurder(PlayerControl pc, PlayerControl tpc)
    {
        ...
        if (CopyCrewVar.GetBool())
        {
            var newRole = role switch
            {
                ...
                CustomRoles.EvilTracker => new[] {CustomRoles.Scout, CustomRoles.TrackerEndKnot}.RandomElement(),
                ...
                CustomRoles.Sunnyboy or CustomRoles.Fabricator => new[] {CustomRoles.Doctor, CustomRoles.ScientistEndKnot}.RandomElement(),
