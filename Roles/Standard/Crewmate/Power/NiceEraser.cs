...
internal class NiceEraser : RoleBase
{
    ...
    public override void AfterMeetingTasks()
    {
        PlayerToErase.ForEach(pc =>
        {
            ...
            CustomRoles erasedRole = player.IsImpostor() ? CustomRoles.ImpostorEndKnot : player.IsCrewmate() ? CustomRoles.CrewmateEndKnot : player.Is(Team.Coven) ? CustomRoles.CovenMember : CustomRoles.Amnesiac;
