...
public class Monarch : RoleBase
{
    ...
    public override bool OnCheckMurder(PlayerControl killer, PlayerControl target)
    {
        ...
        if (target != null && !target.GetCustomRole().IsNotKnightable() && !target.Is(CustomRoles.Knighted) && !target.Is(CustomRoles.Stealer))
        {
            ...
            hasValue |= sender.Notify(killer, CustomRoles.Monarch.ColoredTextByRole(GetString("MonarchKnightedPlayer")), out sender, setName: false);
            ...
            hasValue |= sender.Notify(target, CustomRoles.Monarch.ColoredTextByRole(GetString("KnightedByMonarch")), out sender, setName: false);
