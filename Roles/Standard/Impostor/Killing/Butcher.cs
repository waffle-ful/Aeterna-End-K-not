...
internal class Butcher : RoleBase
{
    ...
    {
        Options.SetupRoleOptions(705000, TabGroup.ImpostorRoles, CustomRoles.Butcher);

        KillCooldown = new FloatOptionItem(705002, "KillCooldown", new(0f, 180f, 0.5f), 30f, TabGroup.ImpostorRoles)
