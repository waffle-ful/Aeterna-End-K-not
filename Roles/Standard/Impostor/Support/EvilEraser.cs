...
internal class EvilEraser : RoleBase
{
    ...
    public override void AfterMeetingTasks()
    {
        PlayerToErase.ForEach(id =>
        {
            ...
            CustomRoles erasedRole = pc.IsImpostor() ? CustomRoles.ImpostorEndKnot : pc.IsCrewmate() ? CustomRoles.CrewmateEndKnot : pc.Is(Team.Coven) ? CustomRoles.CovenMember : CustomRoles.Amnesiac;
