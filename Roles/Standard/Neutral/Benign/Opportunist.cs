...
internal class Opportunist : RoleBase
{
    ...
    {
        return MurderOnly(kind, OppoImmuneToAttacksWhenTasksDone.GetBool() && target.Is(CustomRoles.Opportunist) && target.AllTasksCompleted() ? (int?)AttackDefense.Unstoppable : null);
    }
