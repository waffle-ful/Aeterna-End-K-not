...
public class Cultist : RoleBase
{
    ...
    public override bool OnCheckMurder(PlayerControl killer, PlayerControl target)
    {
        ...
        if (CanBeCharmed(target))
        {
            ...
            hasValue |= sender.Notify(killer, CustomRoles.Cultist.ColoredTextByRole(GetString("CultistCharmedPlayer")), out sender);
            ...
            hasValue |= sender.Notify(target, CustomRoles.Cultist.ColoredTextByRole(GetString("CharmedByCultist")), out sender);
