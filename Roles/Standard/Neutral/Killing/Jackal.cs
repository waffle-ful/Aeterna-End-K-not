...
public class Jackal : RoleBase
{
    ...
    public override bool OnCheckMurder(PlayerControl killer, PlayerControl target)
    {
        ...
        hasValue |= sender.Notify(killer, CustomRoles.Jackal.ColoredTextByRole(GetString("GangsterSuccessfullyRecruited")), out sender, setName: false);
        ...
        hasValue |= sender.Notify(target, CustomRoles.Jackal.ColoredTextByRole(GetString("BeRecruitedByJackal")), out sender, setName: false);
