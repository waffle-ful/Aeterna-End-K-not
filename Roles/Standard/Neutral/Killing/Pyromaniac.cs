...
public class Pyromaniac : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        DouseCooldown = new FloatOptionItem(Id + 11, "PyroDouseCooldown", new(0f, 180f, 0.5f), 20f, TabGroup.NeutralRoles).SetParent(CustomRoleSpawnChances[CustomRoles.Pyromaniac])
            .SetValueFormat(OptionFormat.Seconds);

        BurnCooldown = new FloatOptionItem(Id + 12, "PyroBurnCooldown", new(0f, 180f, 0.5f), 5f, TabGroup.NeutralRoles).SetParent(CustomRoleSpawnChances[CustomRoles.Pyromaniac])
            .SetValueFormat(OptionFormat.Seconds);
