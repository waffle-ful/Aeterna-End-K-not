...
internal class QuizMaster : RoleBase
{
    ...
    public override void Init()
    {
        ...
        CustomQuestions = [];
        EnableCustomQuestions = EnableCustomQuestionsOpt.GetBool() && File.Exists($"{Main.DataPath}/EndKnot_DATA/QuizMasterQuestions.txt");

        if (EnableCustomQuestions)
        {
            string[] lines = File.ReadAllLines($"{Main.DataPath}/EndKnot_DATA/QuizMasterQuestions.txt");
